...
template class Geometry<std::int64_t>;
template class GeometryPBF<double>;
template class GeometryPBF<std::int64_t>;

// decode geometry
template mapnik::geometry::geometry<double> decode_geometry(Geometry<double> & paths, int32_t geom_type, unsigned version);
template mapnik::geometry::geometry<std::int64_t> decode_geometry(Geometry<std::int64_t> & paths, int32_t geom_type, unsigned version);
